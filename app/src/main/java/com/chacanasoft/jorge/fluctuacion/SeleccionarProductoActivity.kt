...
class SeleccionarProductoActivity : AppCompatActivity(), ProductoRecyclerViewAdapter.AdapterInterface{
    ...
    override fun onItemClicked(producto: MiProducto) {
       //devolver producto
        ...
        val dialog = AlertDialog.Builder(this)
                .setTitle("Has seleccionado " + producto.nombre)
                .setMessage("Inserta un precio")
                .setView(taskEditText)
                .setPositiveButton("Add", DialogInterface.OnClickListener { dialog, which ->
                    producto.precio = taskEditText.text.toString()
