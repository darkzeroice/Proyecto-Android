...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
 ...
 //       ventanaPrincipal()
        ...
        btnAgregarCompra.setOnClickListener() {
            val intent = Intent(this, ComprasActivity::class.java)
            this.startActivity(intent)
        }

        btnHistorial.setOnClickListener(){
            val intent = Intent(this, SeleccionarProductoChartActivity::class.java)
        ...
        btnProductos.setOnClickListener(){
            val intent = Intent(this, RegistrarProductosActivity::class.java)
            this.startActivity(intent)
        }
